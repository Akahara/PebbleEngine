...
D3DDevice::D3DDevice(DeviceMode mode, HWND hWnd)
{
...
void D3DDevice::initSwapChain(DeviceMode mode, const HWND hWnd)
{
...
void D3DDevice::resizeWindow(int newWidth, int newHeight)
{
