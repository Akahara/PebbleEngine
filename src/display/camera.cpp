...
{
  m_viewMatrix = XMMatrixTranslationFromVector(-m_position) * XMMatrixRotationQuaternion(m_rotation * vec3{1,1,1,-1});
...
{
  return XMVector3Normalize(XMVector3Cross(getRight(), UP));
}
